<template>
  <div class="container" @click="clickHandle('test click', $event)">
    ...
    <div class="bound">
      <button @click="goChef" open-type="getUserInfo" @getuserinfo="bindGetUserInfo" :userId="userId" :openId="openId">厨师入口</button>
      <!--<button >获取权限</button>-->
      <!--<button @click="goChef">厨师入口</button>-->
    </div>
  </div>
</template>
            ...
            if (res.code) {
              wx.request({
                ...
                success: function (res) {
                  ...
                  wx.request({
                    url: 'http://192.168.188.19:8085/user/register?r=' + Math.random(),
                    data: {
                      realName: Uname,
                      tel: Uphone,
