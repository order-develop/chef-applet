  ...
  <div class="counter-warp">
    ...
    <div class="indent-list">
      <div class="title-box clearfix">
        <div class="time-title">今日订单</div>
        <button @click="SaveFood" class="savefood">验证取餐</button>
      </div>
    ...
    <button @click="FoodFake" class="savefood">验证取餐（假）</button>
    <ul class="nav">
      <li  @click="goOrder">
